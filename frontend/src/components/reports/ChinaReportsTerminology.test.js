...
const expectedTerms = {
  ...
  "review.workspace.queue": "审核工作台",
  "review.workspace.reports": "报告工作台",
  "validation.search.mode.title": "查找待审核结果",
  "validation.search.mode.helper":
    "选择一种查询方式，再加载服务器当前待审核队列。",
  "validation.search.mode.section": "按专业组",
  "validation.search.mode.order": "按申请单",
  "validation.search.mode.range": "申请单范围",
  "validation.search.mode.date": "按检验日期",
