...
public interface ReviewSaveStateDAO {
    record AnalysisState(String id, String testId, String itemId, String sampleId, String accession, String sectionId,
            String statusId, String version, boolean released, boolean printed) {
    }
